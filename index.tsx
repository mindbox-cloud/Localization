 ...
 * @param parameters If translating string include any template, You have to pass object with value, read more https://help.localizejs.com/docs/library-api#section-localize-translate
